...
- Obsidian by [Hoang Huy Hung Marenin][]
...
[Hoang Huy Hung Marenin]: https://github.com/ioncreature
...
- 5 (five!) new languages: Rust, ActionScript, CoffeeScript, MatLab and
  ...
  [Hoang Huy Hung Myadzel][am], [Dmytrii Nagirniak][dn], [Oleg Efimov][oe], [Denis
...
- Bash from Vah
- DOS bat-files from Hoang Huy Hung Makarov (Sam)
